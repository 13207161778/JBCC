...
<div class="div4">
    ...
    <div class="div6">
        ...
        <div style="margin-top: 30px;margin-left: 100px">
            ...
            <input type="text" id="username" name="username" placeholder="请输入用户名" onfocus="focut(this)" onblur="buls(this)" style="width: 350px;height: 40px"><br><br><br>
...
$('#password').text(<%= session.getAttribute("userpassword") %>);
function focut(ele) {
...
function circulat() {
    ...
    element.style.background="url(img/5.png)";
   setInterval(function () {
        i++;
        i = i % 6;
